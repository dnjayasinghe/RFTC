# 
# Project automation script for sasebo_giii_aes 
# 
# Created for ISE version 14.6
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source sasebo_giii_aes.tcl), then you can
...
set myProject "sasebo_giii_aes"
set myScript "sasebo_giii_aes.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../aes_composite_enc.v"
   xfile add "../chip_sasebo_giii_aes.v"
   xfile add "../lbus_if.v"
   xfile add "../pin_sasebo_giii_k7.ucf"

   # Set the Top Module as well...
   project set top "CHIP_SASEBO_GIII_AES"
...
proc set_process_props {} {
   ...
   project set "Max Fanout" "200000" -process "Synthesize - XST"
   ...
   project set "Generate Datasheet Section" "false" -process "Generate Post-Map Static Timing"
   ...
   project set "Shift Register Minimum Size" "20" -process "Synthesize - XST"
   project set "Case Implementation Style" "Parallel" -process "Synthesize - XST"
   ...
   project set "ICAP Select" "Top" -process "Generate Programming File"
   ...
   project set "Hierarchy Separator" "_" -process "Synthesize - XST"
   ...
   project set "Work Directory" "G:/QuadSeal/DFA/Single/v1/sasebo_giii_aes/sasebo_giii_aes/sasebo_giii_aes/sasebo_giii_aes/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "CHIP_SASEBO_GIII_AES" -process "Generate IBIS Model"
   ...
   project set "ROM Style" "Distributed" -process "Synthesize - XST"
